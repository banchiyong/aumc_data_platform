...
import AutomationDownloadButton from '../AutomationDownloadButton'

interface AutomationRequestDetailPageProps {
  params: Promise<{
    id: string
  }>
}
...
export default async function AutomationRequestDetailPage({ params }: AutomationRequestDetailPageProps) {
  ...
  if (response.error || !response.data) {
    return (
      <div className="space-y-6">
        <Link href="/researcher/automation-services">
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-3xl font-bold text-gray-900">자동화 서비스 신청 상세</h1>
        {(request.status === 'DRAFT' || request.status === 'REVISION_REQUESTED') && (
          <Link href={`/researcher/automation-services/${id}/edit`}>
            <Button>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <div className="space-y-6 lg:col-span-2">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div>
                  ...
                  <p className="mt-1">{request.requester_phone}</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              <CardTitle>업무 및 요구사항</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
                <p className="text-sm font-medium text-gray-500">관련 시스템/업무 영역</p>
                <p className="mt-1">{request.related_system || '-'}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="mt-1 whitespace-pre-wrap">{request.special_notes || '-'}</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              <CardTitle>ROI 및 투입 정보</CardTitle>
            </CardHeader>
            <CardContent className="grid gap-4 md:grid-cols-2">
              ...
              <div>
                <p className="text-sm font-medium text-gray-500">자동화 후 예상 소요 시간</p>
